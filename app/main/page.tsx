        ...
        <div className='max-w-3xl w-full'>
          ...
          <div className='text-center mb-8'>
            ...
            <p className='mt-2 max-w-xl mx-auto'>
              I love to code and build things. I want keep learning and keep
              building. I do build websites and apps for fun. I am a gamer so I
          ...
          <div>
            ...
            <div className='space-y-4'>
              ...
              <div className='text-center'>
                ...
                <p>
                  This is a Discord bot that tracks users&apos; activity in
