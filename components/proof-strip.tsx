...
export function ProofStrip() {
  ...
  return (
    <section className='px-4 sm:px-6 lg:px-12 py-8 sm:py-12 border-t border-border'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 sm:gap-8'>
          {metrics.map((metric) => (
            ...
            >
              ...
              <p className='text-lg sm:text-xl lg:text-2xl font-mono font-semibold wrap-break-word'>
                {metric.value}
              </p>
            </div>
          ))}
